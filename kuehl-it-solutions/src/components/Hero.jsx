...
export default function Hero() {
    return (
        <section className="relative h-screen flex flex-col items-center justify-center z-10 text-white px-4 md:px-6">
            <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, ease: "easeOut" }}
                className="text-center mix-blend-difference w-full max-w-4xl"
            >
                ...
                <p className="text-lg sm:text-xl md:text-2xl font-light tracking-[0.2em] uppercase text-gray-300">
                    Solutions
                </p>
            </motion.div>
